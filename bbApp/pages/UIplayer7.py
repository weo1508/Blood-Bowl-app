...
st.set_page_config(page_title= 'UIplayer7', layout="wide", initial_sidebar_state="collapsed", menu_items=None)
...
st.subheader("Hire Journeymen")
st.text("Now hire journeymen")

next = st.button("next", use_container_width=True)
m.nextPage(next, "UIplayer8")